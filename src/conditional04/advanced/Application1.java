package conditional04.advanced;
...
public class Application1 {
	...
	public static void main(String[] args) {
		...
		if (isaBoolean(a, b, c) && average >= 60){
	...
	private static boolean isaBoolean(int a, int b, int c) {
		return isSuccessed(a) && isSuccessed(b) && isSuccessed(c);
	}

	private static boolean isSuccessed(int a) {
		return a >= 40;
	}
